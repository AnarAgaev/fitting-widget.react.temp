const calculateSketchPosition = (canvas: HTMLCanvasElement, img: HTMLImageElement)
	...
	*
	* Позиции по оси X и Y рассчитываем, как половида дельты между
...
export default calculateSketchPosition
